...
mongoose.connect('mongodb+srv://chaman:<password>@cluster0.xvezxv3.mongodb.net/?retryWrites=true&w=majority/twitter', { useNewUrlParser: true, useUnifiedTopology: true  })
    .then(() => {
